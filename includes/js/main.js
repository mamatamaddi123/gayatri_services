! function(t) {
    ...
    if (/^((?!chrome|android).)*safari/i.test(navigator.userAgent), /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent) && (h = !0), /iPhone|iPad|iPod/i.test(navigator.userAgent), t(".image-back-offset-shadow, .vertical-counter, .counter, .progress-bar, .pie-chart-style-01, .pie-chart-style-02").each((function() {
            ...
            if (a > n) {
                ...
                var i = t(this).position().left,
                    s = t(this).outerWidth(),
                    r = t(".navbar-collapse").offset().left,
                    l = o.outerWidth(),
                    c = i + s / 2 - l / 2,
                    d = a - r;
                c + r < 0 ? c = 30 - r : c + l > d && (c = d - l - 30), o.css({
                    left: c + "px"
                })
        ...
        })), F(), X(), j(), H(2e3), N(), $(), W(), _(), t(".fit-videos").fitVids(), t("[data-scroll-options]").each((function() {
            var e = t(this),
            ...
            if (!t(this).hasClass("appear")) {
                ...
                t(this).animate({
                    ...
                    duration: 300,
                    easing: "swing",
                    progress: function(e, o, n) {
                        var i = parseInt(a * o);
                        t(this).find("span").html(i + "%")
                    }
                })
            }
            ...
            t(".pie-chart-style-01").easyPieChart({
                ...
                barColor: function() {
                    ...
                    var e = this.renderer.getCtx(),
                        ...
                        i = e.createLinearGradient(0, 0, n.width, 270);
                    return i.addColorStop(.2, a), i.addColorStop(0, o), i
                },
                animate: {
                    duration: 2e3,
                    enabled: !0
            ...
            var a = t(this).width(),
                ...
                n = t(this).find(".caption").html(),
                i = t(this).offset(),
                s = e.pageX - i.left + 20,
                r = e.pageY - i.top;
            s + o + 30 > a && (s = s - o - 65), t(this).css("overflow", "visible"), t(this).find(".jg-caption").html(n).show().css({
                left: s + "px",
                right: "auto",
                top: r + "px",
                bottom: "auto"
            ...
            var o = e.attr("data-filter"),
                n = a.find(".portfolio-wrapper");
            return L(n), n.isotope({
                filter: o
            }), !1
            ...
            var o = "IGQVJXTm1iQkFKNHlTNlNuTG9lcnltRVM2dG9XTC05Wnc4aEtMTFVpVzNOQkFVWExGbXNLTTlNWjZAwUXA3WUFjSzBsbWRsQXExS0o1ZA2JPdndDUFlFWUdMSkhrVmNkX1RDYjhZAT29yRzh2UXAxeTNqVgZDZD",
                n = t(e),
                i = (o = n.attr("data-token") || o, n.attr("data-total") || "6"),
                s = n.attr("data-slider-options"),
                r = n.html(),
                l = "";
            null != s && n.html(""), t.ajax({
                ...
                type: "GET",
                success: function(a) {
                    for (var o in l += n.find(".grid-item").length > 0 ? '<li class="grid-sizer"></li>' : "", a.data)
                        if (o < parseInt(i) && "IMAGE" == a.data[o].media_type) {
                    ...
                    if (n.html(l), null != s) {
                        var g = t.parseJSON(s),
                            v = e.parentElement;
                        new Swiper(v, g)
                    } else !n.find(".wow").length > 0 && n.find(".grid-item").css("visibility", "hidden"), n.imagesLoaded((function() {
                        !n.find(".wow").length > 0 ? n.find(".grid-item").css("visibility", "") : h || n.find(".grid-item").css("visibility", "hidden"), n.removeClass("grid-loading"), n.isotope({
                            layoutMode: "masonry",
                            itemSelector: ".grid-item",
                            percentPosition: !0,
                            stagger: 0,
                ...
                error: function(e) {
                    n.append('<div class="col-12"><span class=text-center>No Images Found</span></div>')
                }
            })
    ...
    if (t(".portfolio-colorful").length > 0)
        for (var m = t(".portfolio-colorful").find(".grid-item").length, f = t(".portfolio-colorful").attr("data-backgroundcolor") || "#2e94eb", g = t(".portfolio-colorful").attr("data-opacity") || 1, v = (k = f.split(",")).length, b = 0; b < m; b++) {
            var w = k[b],
                C = "rgba(" + parseInt(w.slice(-6, -4), 16) + "," + parseInt(w.slice(-4, -2), 16) + "," + parseInt(w.slice(-2), 16) + "," + g + ")";
            t(".portfolio-colorful").find(".portfolio-hover:eq(" + b + ")").css("background-color", C), v < m && k.push(k[b])
        }
    if (t(".page-title-colorful").length > 0) {
        var y, k = (f = t(".page-title-colorful").attr("data-backgroundcolor") || "#2e94eb").split(","),
            x = (v = (k = f.split(",")).length, 1);
        t(".page-title-colorful").css({
            "background-color": k[0]
        }), setInterval((function() {
            y = k[x], t(".page-title-colorful").css({
                "background-color": y
            }), ++x === v && (x = 0)
        }), 5e3)
    }
    t(document).on("click", ".search-form-icon", (function(e) {
        ...
        return a.find("input[type=text]").each((function(o) {
            var n = t(this).val();
            null === n || "" === n ? (a.find("input:eq(" + o + ")").addClass("search-error"), e = !1) : a.find("input:eq(" + o + ")").removeClass("search-error")
        })), e
        ...
        t("body").toggleClass("show-menu"), t(".left-sidebar-wrapper").length > 0 && A() <= n && t("body").toggleClass("left-classic-mobile-menu"), t(".sub-menu-item").collapse("hide"), t(".menu-list-item.open").removeClass("show")
    ...
    t(".lightbox-group-gallery-item").each((function() {
        ...
        callbacks: {
            beforeOpen: function() {
                A() < 700 ? this.st.focus = !1 : this.st.focus = "#name"
            }
        }
        ...
        var e = !1,
            ...
            i = /^([\w-\.]+@([\w-]+\.)+[\w-]{2,4})?$/,
            s = /[0-9 -()+]+$/,
            r = (n.attr("action"), n.find(".form-results"), o.attr("data-sitekey") || "");
        n.find('[name="redirect"]').val(), n.find(".required").removeClass("error"), n.find(".required").each((function() {
            var a = t(this),
                o = a.val();
            "" == o || null == o ? (e = !0, a.addClass("error")) : ("email" != a.attr("type") || i.test(o)) && ("tel" != a.attr("type") || s.test(o)) || (e = !0, a.addClass("error"))
        }));
        var l = n.find(".terms-condition");
        return l.length > 0 && (l.is(":checked") || (e = !0, l.addClass("error"))), "undefined" != typeof grecaptcha && null !== grecaptcha && (n.find(".g-recaptcha").length > 0 ? grecaptcha.getResponse().length || (e = !0, n.find(".g-recaptcha").addClass("error")) : "" != r && null != r && (a = !0, n.find("input[name=action],input[name=g-recaptcha-response]").remove(), grecaptcha.ready((function() {
            grecaptcha.execute(r, {
                action: "subscribe_newsletter"
            }).then((function(t) {
                n.prepend('<input type="hidden" name="g-recaptcha-response" value="' + t + '">'), n.prepend('<input type="hidden" name="action" value="subscribe_newsletter">'), e || R(o)
            }))
        })))), e || a || R(o), !1
    })), t(document).on("blur", ".required", (function() {
        var e = t(this).val();
        "" == e || null == e || "email" == t(this).attr("type") && !/^([\w-\.]+@([\w-]+\.)+[\w-]{2,4})?$/.test(e) || "tel" == t(this).attr("type") && !/[0-9 -()+]+$/.test(e) ? t(this).addClass("error") : t(this).removeClass("error")
    ...
    var T = t("body").attr("data-mobile-nav-style");
    if (("modern" == T || "full-screen-menu" == T) && !t(".navbar-" + T + "-inner").length) {
        if (!t(".box-layout").length > 0 && "modern" == T ? t("section, footer").wrapAll('<div class="page-layout"></div>') : t("section").wrapAll('<div class="page-layout"></div>'), t(".navbar .navbar-toggler").clone(!0).addClass("navbar-toggler-clone").insertAfter(".page-layout"), t(".navbar .navbar-collapse").clone(!0).addClass("navbar-collapse-clone").attr("id", "navbarNav-clone").insertAfter(".page-layout"), t(".navbar-toggler-clone, .navbar-collapse-clone").wrapAll('<div class="navbar-' + T + '-inner"></div>'), t(".navbar-toggler").attr("data-bs-target", "#navbarNav-clone").attr("aria-controls", "#navbarNav-clone"), t(".navbar-" + T + "-inner").find(".dropdown-toggle").addClass("dropdown-toggle-clone"), t(".navbar-collapse-clone").length > 0) {
            var O = t(".navbar-collapse-clone").attr("data-scroll-options") || '{ "theme": "light" }';
            null != O && (O = t.parseJSON(O), t(".navbar-collapse-clone").mCustomScrollbar(O))
        }
        "modern" == T && t('<div class="navbar-show-modern-bg"></div>').insertAfter(".page-layout")
    }
    ...
    function N() {
        ...
        a.each((function() {
            var o = t(this),
                n = o.attr("href").indexOf("#");
            if (n > -1) {
                var i = o.attr("href").substring(n);
                if ("" != i && "#" != i && t(i).length > 0) {
                    var s = t(o.attr("href"));
                    s.position().top <= e + 60 && s.position().top + s.height() > e + 60 && (a.removeClass("active"), o.addClass("active")), e < 1 && o.removeClass("active")
                }
            }
        }));
        var o = 0,
            i = 0;
        t("nav").length > 0 && (o = t("nav").outerHeight()), t(".top-bar").length > 0 && (i = t(".top-bar").outerHeight());
        var r = o + i;
        if (t("header").hasClass("no-sticky") || (e >= r ? (t("header").addClass("sticky"), t(".header-with-topbar .top-bar").is(":hidden") || (t(".header-with-topbar .top-bar").css({
                top: "-" + i + "px"
            }), t(".header-with-topbar .fixed-top").css({
                top: "0px"
            }))) : e <= r && (t(".header-with-topbar .top-bar").css({
                top: "0px"
            }), t(".header-with-topbar .fixed-top").css({
                top: i + "px"
            ...
            var l = e;
            l < s ? (l -= 1, t(".sticky").removeClass("header-appear"), t(".dropdown.on").removeClass("on").removeClass("show").find(".dropdown-menu").fadeOut(100)) : t(".sticky").addClass("header-appear"), (s = l) <= o && t("header").removeClass("header-appear")
        }
        e >= 200 && A() > n && (t(".navbar-collapse").hasClass("show") && t(".navbar-collapse").removeClass("show"), t("body").hasClass("navbar-collapse-show") && (t("body").removeClass("navbar-collapse-show"), t("html").removeClass("overflow-hidden"))), e > 150 ? (t(".scroll-top-arrow").fadeIn("300"), !t(".show-theme-demos").length && A() > 1199 && t(".theme-demos").fadeIn("300")) : t(".scroll-top-arrow").fadeOut("300")
    }
    ...
    function W() {
        document.querySelectorAll(".swiper-container:not( .instafeed-wrapper )").forEach((function(e, a) {
            var o = t(e),
                n = o.attr("data-slider-options");
            if (null != n) {
                n = t.parseJSON(n);
                var s = o.attr("data-slider-md-direction");
                if ("" != s && null != s) {
                    var r = "" != n.direction && null != n.direction ? n.direction : s;
                    n.on = {
                        init: function() {
                            A() <= i ? this.changeDirection(s) : this.changeDirection(r), this.update()
                        },
                        resize: function() {
                            A() <= i ? this.changeDirection(s) : this.changeDirection(r), this.update()
                        }
                ...
                if ("" != n.thumbs && null != n.thumbs) {
                    var l = o.attr("data-thumb-slider-md-direction");
                    if ("" != l && null != l) {
                        var c = "" != n.thumbs.swiper.direction && null != n.thumbs.swiper.direction ? n.thumbs.swiper.direction : l;
                        n.thumbs.swiper.on = {
                            init: function() {
                                A() <= i ? this.changeDirection(l) : this.changeDirection(c), this.update()
                            },
                            resize: function() {
                                A() <= i ? this.changeDirection(l) : this.changeDirection(c), this.update()
                            },
                ...
                "" != p && null != p && (n.on.slideChange = function() {
                ...
                "" != u && null != u && null != (u = t.parseJSON(u)) && (n.pagination.renderBullet = function(e, t) {
                    return '<span class="' + t + '" style="background-image: url( ' + u[e] + ' )"></span>'
                });
                var m = new Swiper(e, n);
                d.push(m)
            }
        }))
    }
    ...
    function _() {
        for (var e = 0; e < d.length; e++) {
            ...
            "" != a && null != a && (A() <= a ? t.destroy(!1, !0) : t.destroyed && (d.splice(e, 1), W()))
        }
    }
            ...
            setTimeout((function() {
                e.imagesLoaded((function() {
                    var t = e.closest("section"),
                        ...
                        n = o + a;
                    n = e.hasClass("overlap-section-one-fourth") ? o / 4 - n : e.hasClass("overlap-section-three-fourth") ? 3 * o / 4 - n : o / 2 - n, e.css("margin-top", n);
                    var i = t.prev("section.overlap-height"),
                        s = i.find(".overlap-gap-section");
                    i.imagesLoaded((function() {
                        if (s.length > 0) {
                            var e = s.outerHeight() + (Math.abs(n) - a);
                            s.parents("section.overlap-height").height(e)
                        }
                    }))
                }))
            }), 10)
    ...
    function H(e) {
        t(".overlap-section-bottom").length > 0 && A() >= 768 ? t(".overlap-section-bottom").each((function() {
            var a = t(this),
    ...
    function J() {
        var e = 0;
        return t("header nav.navbar").length > 0 && (e += t("header nav.navbar").outerHeight()), t(".top-bar").length > 0 && (e += t(".top-bar").outerHeight()), t(".sidebar-nav-action").length > 0 && A() <= n && (e += t(".sidebar-nav-action").outerHeight()), t(".side-menu-header").length > 0 && A() <= n && (e += t(".side-menu-header").outerHeight()), e
    }

    function G() {
        var e = J();
        t(".navbar").hasClass("no-sticky") || !t(".navbar").hasClass("top-space") && !t(".navbar").hasClass("mobile-top-space") ? t("body").css("padding-top", "") : t("body").css("padding-top", e + "px"), t(".mobileoff-fullscreen-top-space").length >= 0 && A() > 1023 && t(".mobileoff-fullscreen-top-space").css("height", B() - e + "px"), t(".fullscreen-top-space").length >= 0 && t(".fullscreen-top-space").css("height", B() - e + "px"), (t(".sidebar-nav-action").length > 0 || t(".side-menu-header").length > 0) && (A() <= n ? t("body").css("padding-top", e + "px") : t("body").css("padding-top", ""))
    }
    ...
    function V(e, t, a) {
        ...
        var n = 0 != a && "" != a ? o.toUTCString() : 0;
        document.cookie = e + "=" + t + ";expires=" + n + ";path=/"
    }

    function X() {
        E(), G(), t(".vertical-counter").each((function() {
            var e = t(this),
                a = e.css("font-size");
    ...
    function R(e) {
        var a = e.parents("form"),
            o = a.attr("action"),
            n = a.find(".form-results"),
            i = a.find('[name="redirect"]').val();
        "" != o && null != o && (e.addClass("loading"), t.ajax({
            type: "POST",
            url: o,
            data: a.serialize(),
            success: function(o) {
                e.removeClass("loading"), "" != i && null != i ? window.location.href = i : (null != o && (o = t.parseJSON(o)), a.find("input[type=text],input[type=email],input[type=tel],input[type=password],textarea").each((function() {
    ...
    t(document).on("click", ".navbar-toggle", (function() {
        A() > n && (D ? !t(".navbar-collapse").has(e.target).is(".navbar-collapse") && t(".navbar-collapse ul").hasClass("show") && (t(".navbar-collapse").find("a.dropdown-toggle").addClass("collapsed"), t(".navbar-collapse").find("ul.dropdown-menu").removeClass("show"), t(".navbar-collapse a.dropdown-toggle").removeClass("active")) : (D = !0, setTimeout((function() {
            D = !1
        }), 500), t("body").addClass("show-menu")))
    })), t(".dropdown").on("mouseenter touchstart", (function(e) {
        var a = t(this);
        a.siblings(".dropdown").removeClass("open"), a.parents(".navbar-nav").siblings(".navbar-nav").find(".dropdown").removeClass("open"), a.addClass("open"), A() > n && (function(e) {
            var t = A();
            if (e.hasClass("simple-dropdown")) {
                r = e, l = e.find("a.nav-link");
            ...
            if (e.parent().hasClass("dropdown-menu") && e.parents(".simple-dropdown")) {
                ...
                o = e.outerWidth() - l.outerWidth(), e.find(".dropdown-menu").each((function() {
                    ...
                    e.find("li").hasClass("dropdown") ? (o += e.outerWidth(), e.find("li.dropdown").each((function() {
                        ...
                        t.push(a.outerWidth())
                    })), n = i + Math.max.apply(Math, t), i = n, o += n, s += 1) : s < 1 && (o += e.outerWidth())
                }));
                var c = t - (r.offset().left + r.outerWidth());
                if (o > c) {
        ...
        E(), t(".page-loader").length > 0 && t(".page-loader").fadeOut(), M(c, !1), q(), $(), t(".rev-nav-ares-effect").length > 0 && setTimeout((function() {
