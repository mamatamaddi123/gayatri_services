...
<head>
    ...
    <!-- favicon icon -->
    <link rel="shortcut icon" href="./includes/img/logo/favi.png">
    <link rel="apple-touch-icon" href="./includes/img/logo/favi.png">
    <link rel="apple-touch-icon" sizes="72x72" href="./includes/img/logo/favi.png">
    <link rel="apple-touch-icon" sizes="114x114" href="./includes/img/logo/favi.png">
...
<?php include './includes/header.php' ?>
    ...
    <section class="p-0">
        <div class="container-fluid position-relative">
            <div class="row">
                <div class="swiper-container white-move  p-0 md-h-150px sm-h-150px" data-slider-options='{ 
                "slidesPerView": 1, 
                "loop": true, 
                    ...
                    <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide cover-background">
                            <picture>
                                ...
                                <img loading="lazy" class="lazy-img" data-src="./includes/img/slider/s2.png" alt="brown ACP sheet commercial building" decoding="async" />
                            </picture>
                        </div>
                        <div class="swiper-slide cover-background">
                            <picture>
                                <source srcset="./includes/img/slider/s7-mobile.png" media="(max-width: 767px)">
                                <img loading="lazy" class="lazy-img" data-src="./includes/img/slider/s7.png" alt="commercial building acp sheet" decoding="async" />
                            </picture>
                        </div>
                        <div class="swiper-slide cover-background">
                            <picture>
                                <source srcset="./includes/img/slider/s8-mobile.png" media="(max-width: 767px)">
                                <img loading="lazy" class="lazy-img" data-src="./includes/img/slider/s8.png" alt="acp sheet grey colour" decoding="async" />
                            </picture>
                        </div>
                        <div class="swiper-slide cover-background">
                            <picture>
                                <source srcset="./includes/img/slider/s9-mobile.png" media="(max-width: 767px)">
                                <img loading="lazy" class="lazy-img" data-src="./includes/img/slider/s9.png" alt="grey ACP sheet" decoding="async" />
                            </picture>
                        </div>
                    </div>
    ...
    <section class="big-section" style="background-color: #324b75;">
        <div class="container">
            <div class="row">
                <div class="col-12 col-lg-4 col-md-4 col-sm-6 text-center text-md-center sm-margin-30px-bottom xs-margin-40px-bottom wow animate__fadeIn" data-wow-delay="0.1s">
                    <div class="bg-white border-radius-6px overflow-hidden padding-2-rem-lr padding-30px-tb lg-padding-1-half-rem-lr md-padding-2-half-rem-lr box-shadow-large">
                        <img class="mb-4 lazy-img" width="90" height="90px" data-src="./includes/img/home/year-warranty.png" alt="10 year warranty">
                        <div class="d-flex flex-row align-item-start margin-10px-bottom justify-content-center justify-content-md-center">
                            <p class="appear d-inline-flex alt-font text-dark font-weight-600 home_h2_to_p letter-spacing-minus-3px mb-0 sm-letter-spacing-minus-1-half">
                                10</p><span class="text-light-brownish-orange text-extra-large font-weight-500 margin-5px-left">+</span>
                        </div>
                        <span class="alt-font text-medium text-dark text-uppercase d-block letter-spacing-2px">Year
                        Warranty</span>
                    </div>
                </div>
                <div class="col-12 col-lg-4 col-md-4 col-sm-6 text-center text-md-center sm-margin-30px-bottom xs-margin-40px-bottom wow animate__fadeIn" data-wow-delay="0.2s">
                    <div class="bg-white border-radius-6px overflow-hidden padding-2-rem-lr padding-30px-tb lg-padding-1-half-rem-lr md-padding-2-half-rem-lr box-shadow-large">
                        <img class="mb-4 lazy-img" width="90" height="90px" data-src="./includes/img/home/production_capacity.png" alt="2.5M sq m. production capacity">
                        <div class="d-flex flex-row align-item-start margin-10px-bottom justify-content-center justify-content-md-center">
                            <p class="d-inline-flex alt-font text-dark font-weight-600 letter-spacing-minus-3px mb-0 home_h2_to_p sm-letter-spacing-minus-1-half">
                                2.5M</p><span class="text-light-brownish-orange text-extra-large font-weight-500 margin-5px-left">sq
                            m.</span>
                        </div>
                        <span class="alt-font text-medium text-dark text-uppercase d-block letter-spacing-2px">Production
                        Capacity</span>
                    </div>
                </div>
                <div class="col-12 col-lg-4 col-md-4 col-sm-6 text-center text-md-center wow animate__fadeIn" data-wow-delay="0.4s">
                    <div class="bg-white border-radius-6px overflow-hidden padding-2-rem-lr padding-30px-tb lg-padding-1-half-rem-lr md-padding-2-half-rem-lr box-shadow-large">
                        <img class="mb-4 lazy-img" width="90" height="90px" data-src="./includes/img/home/weather_resistance.png" alt="100% Weather Resistance">
                        <div class="d-flex flex-row align-item-start margin-10px-bottom justify-content-center justify-content-md-center">
                            <p class="appear d-inline-flex alt-font text-dark font-weight-600 letter-spacing-minus-3px home_h2_to_p mb-0 sm-letter-spacing-minus-1-half">
                                100</p><span class="text-light-brownish-orange text-extra-large font-weight-500 margin-5px-left">%</span>
                        </div>
                        <span class="alt-font text-medium text-dark text-uppercase d-block letter-spacing-2px">Weather
                        Resistance</span>
                    </div>
                </div>
            </div>
...
<div class="container py-5">
        ...
        <div class="product-image-box">
          <div class="shop-product-image">
            <a href="./products.php" class="product-view-link">
              <img src="<?php echo $item['image_path']; ?>" alt="<?php echo $item['item_Name']; ?>" class="img-fluid">
            </a>
          </div>
          <div class="shop-product-content">
            <h4 class="product-title"><?php echo $item['item_Name']; ?></h4>
            <p class="product-price">Item Code: <?php echo $item['item_Code']; ?></p>
  ...
  <div class="text-center mt-4">
        ...
        <div class="container">
            <div class="row justify-content-md-center">
                <div class="col-12 col-lg-4 col-md-6 col-sm-7 d-flex flex-column md-margin-6-rem-bottom sm-margin-5-rem-bottom wow animate__fadeIn">
                    <h1 class="alt-font main_heading_home text-uppercase w-80 text-extra-dark-gray font-weight-600 margin-20px-bottom lg-w-90 md-w-75 md-margin-10px-bottom">
                        Premium ACP Sheets & Partition Solutions Provider</h1>
                ...
                <div class="col-12 col-lg-4 col-md-6 last-paragraph-no-margin  md-margin-6-rem-bottom sm-margin-50px-bottom wow animate__fadeIn" data-wow-delay="0.2s" data-wow-duration="0.3">
                    <div class="alt-font text-uppercase text-extra-medium font-weight-600 text-extra-dark-gray margin-25px-bottom sm-margin-15px-bottom">
                        Quality & Innovation 2025</div>
                    <p class="w-85 xl-w-100 text-justify">Gayatri Services is a trusted name in providing premium-quality ACP sheets and partition sheet solutions for residential, commercial, and industrial projects. With a strong commitment to quality, innovation, and customer satisfaction, we deliver materials that combine strength, style, and durability to enhance every space.</p>
                ...
                <div class="col-12 col-lg-4 last-paragraph-no-margin">
                    <div class="outside-box-bottom position-relative">
                        <img data-src="https://www.maplacp.com/wp-content/uploads/2024/02/acp-sheets.webp" class="wow animate__fadeInRight lazy-img" data-wow-delay="0.5s" alt="We Are The Leading Manufacturer Of ACP Sheets" />
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div class="swiper-container portfolio-classic position-relative" data-slider-options='{ "slidesPerView": 1, "spaceBetween": 30, "navigation": { "nextEl": ".swiper-button-next-nav", "prevEl": ".swiper-button-previous-nav" }, "autoplay": { "delay": 3000, "disableOnInteraction": false }, "keyboard": { "enabled": true, "onlyInViewport": true }, "breakpoints": { "1200": { "slidesPerView": 4 }, "992": { "slidesPerView": 3 }, "768": { "slidesPerView": 2 } }, "effect": "slide" }'>
                            <div class="swiper-wrapper">
                                ...
                                <div class="swiper-slide overflow-hidden">
                                    <div class="portfolio-box">
                                        <div class="portfolio-image">
                                            <a href="./wooden-acp-sheet"><img class="lazy-img"
                                            ...
                                            <div class="portfolio-hover align-items-center justify-content-center">
                                                <div class="hover-center">
                                                    ...
                                                    <div class="portfolio-icon">
                                                        <a href="./wooden-acp-sheet" class="rounded-circle bg-dark">
                                        ...
                                        <div class="portfolio-caption padding-30px-top sm-padding-15px-tb">
                                            <a href="./wooden-acp-sheet" class="alt-font text-black font-weight-500 text-uppercase d-inline-block margin-5px-bottom">Wood
                                            Grain series</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="swiper-slide overflow-hidden">
                                    <div class="portfolio-box">
                                        <div class="portfolio-image">
                                            <a href="./marble-acp-sheet"><img class="lazy-img"
                                            ...
                                            <div class="portfolio-hover align-items-center justify-content-center">
                                                <div class="hover-center">
                                                    ...
                                                    <div class="portfolio-icon">
                                                        <a href="./marble-acp-sheet" class="rounded-circle bg-dark"><i
                                        ...
                                        <div class="portfolio-caption padding-30px-top sm-padding-15px-tb">
                                            <a href="./marble-acp-sheet" class=" alt-font text-black font-weight-500 text-uppercase d-inline-block margin-5px-bottom">Marble
                                            series</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="swiper-slide overflow-hidden">
                                    <div class="portfolio-box">
                                        <div class="portfolio-image">
                                            <a href="./galaxy-acp-sheet"><img class="lazy-img"
                                            ...
                                            <div class="portfolio-hover align-items-center justify-content-center">
                                                <div class="hover-center">
                                                    ...
                                                    <div class="portfolio-icon">
                                                        <a href="./galaxy-acp-sheet" class="rounded-circle bg-dark "><i
                                                            class="ti-arrow-right text-white"></i></a>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="portfolio-caption padding-30px-top sm-padding-15px-tb">
                                            <a href="./galaxy-acp-sheet" class="alt-font text-black font-weight-500 text-uppercase d-inline-block margin-5px-bottom">Galaxy
                                            series</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="swiper-slide overflow-hidden">
                                    <div class="portfolio-box">
                                        <div class="portfolio-image">
                                            ...
                                            <div class="portfolio-hover align-items-center justify-content-center">
                                                <div class="hover-center">
                                                    ...
                                                    <div class="portfolio-icon">
                                                        <a href="./mirror-acp-sheet" class="rounded-circle bg-dark"><i
                                                            class="ti-arrow-right text-white"></i></a>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="portfolio-caption padding-30px-top sm-padding-15px-tb">
                                            <a href="./mirror-acp-sheet" class="alt-font text-black font-weight-500 text-uppercase d-inline-block margin-5px-bottom">Mirror
                                            series</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="swiper-slide overflow-hidden">
                                    <div class="portfolio-box">
                                        <div class="portfolio-image">
                                            ...
                                            <div class="portfolio-hover align-items-center justify-content-center">
                                                <div class="hover-center">
                                                    ...
                                                    <div class="portfolio-icon">
                                                        <a href="./brush-acp-sheet" class="rounded-circle bg-dark"><i
                                                            class="ti-arrow-right text-white"></i></a>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="portfolio-caption padding-30px-top sm-padding-15px-tb">
                                            <a href="./brush-acp-sheet" class="alt-font text-black font-weight-500 text-uppercase d-inline-block margin-5px-bottom">Brush
                                            series</a>
                                        </div>
                                    </div>
                                </div>
    ...
    <section class="bg-medium-gray overflow-visible big-section">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-12 col-lg-7 col-sm-8 text-center margin-3-rem-bottom md-margin-3-rem-bottom wow animate__fadeIn" style="visibility: visible; animation-name: fadeIn;">
                    <h3 class="alt-font title-large-2 home_title text-theme font-weight-700 text-uppercase mb-0">Projects
                    </h3>
                    <span class="d-inline-block alt-font text-extra-dark-gray text-large text-uppercase font-weight-500 letter-spacing-1px margin-20px-bottom margin-10px-top">Never
                    regret anything that made you smile.</span>
                </div>
            </div>
            <div class="row justify-content-center">
                <div class="col-12 col-lg-3  col-md-8 col-sm-10 margin-30px-bottom xs-margin-15px-bottom wow animate__fadeIn" data-wow-delay="0.4s">
                    <div class="feature-box feature-box-left-icon-middle bg-white">
                        <div class="feature-box-icon">
                            <img class="lazy-img box-shadow-large border-all border-width-6px border-color-white " data-src="./includes/img/project/Ahemdabad.png" alt="Our Project Real Images">
                        </div>
                    </div>
                </div>
                <div class="col-12 col-lg-3  col-md-8 col-sm-10 margin-30px-bottom xs-margin-15px-bottom wow animate__fadeIn" data-wow-delay="0.4s">
                    <div class="feature-box feature-box-left-icon-middle bg-white">
                        <div class="feature-box-icon">
                            <img class="lazy-img box-shadow-large border-all border-width-6px border-color-white " data-src="./includes/img/project/Laxmi Celebration.png" alt="Our Project Real Images">
                        </div>
                    </div>
                </div>
                <div class="col-12 col-lg-3  col-md-8 col-sm-10 margin-30px-bottom xs-margin-15px-bottom wow animate__fadeIn" data-wow-delay="0.4s">
                    <div class="feature-box feature-box-left-icon-middle bg-white">
                        <div class="feature-box-icon">
                            <img class="lazy-img box-shadow-large border-all border-width-6px border-color-white " data-src="./includes/img/project/Luxurico Ceramic Morbi.png" alt="Our Project Real Images">
                        </div>
                    </div>
                </div>
                <div class="col-12 col-lg-3  col-md-8 col-sm-10 margin-30px-bottom xs-margin-15px-bottom wow animate__fadeIn" data-wow-delay="0.4s">
                    <div class="feature-box feature-box-left-icon-middle bg-white">
                        <div class="feature-box-icon">
                            <img class="lazy-img box-shadow-large border-all border-width-6px border-color-white " data-src="./includes/img/project/Maliya.png" alt="Our Project Real Images">
                        </div>
                    </div>
                </div>
                <div class="col-12 col-lg-3  col-md-8 col-sm-10 margin-30px-bottom xs-margin-15px-bottom wow animate__fadeIn" data-wow-delay="0.4s">
                    <div class="feature-box feature-box-left-icon-middle bg-white">
                        <div class="feature-box-icon">
                            <img class="lazy-img box-shadow-large border-all border-width-6px border-color-white " data-src="./includes/img/project/Morbi.png" alt="Our Project Real Images">
                        </div>
                    </div>
                </div>
                <div class="col-12 col-lg-3  col-md-8 col-sm-10 margin-30px-bottom xs-margin-15px-bottom wow animate__fadeIn" data-wow-delay="0.4s">
                    <div class="feature-box feature-box-left-icon-middle bg-white">
                        <div class="feature-box-icon">
                            <img class="lazy-img box-shadow-large border-all border-width-6px border-color-white " data-src="./includes/img/project/Star Business Hub Kadi.png" alt="Our Project Real Images">
                        </div>
                    </div>
                </div>
                <div class="col-12 col-lg-3  col-md-8 col-sm-10 margin-30px-bottom xs-margin-15px-bottom wow animate__fadeIn" data-wow-delay="0.4s">
                    <div class="feature-box feature-box-left-icon-middle bg-white">
                        <div class="feature-box-icon">
                            <img class="lazy-img box-shadow-large border-all border-width-6px border-color-white " data-src="./includes/img/project/Surat Mumbai Highway.png" alt="Our Project Real Images">
                        </div>
                    </div>
                </div>
                <div class="col-12 col-lg-3  col-md-8 col-sm-10 margin-30px-bottom xs-margin-15px-bottom wow animate__fadeIn" data-wow-delay="0.4s">
                    <div class="feature-box feature-box-left-icon-middle bg-white">
                        <div class="feature-box-icon">
                            <img class="lazy-img box-shadow-large border-all border-width-6px border-color-white " data-src="./includes/img/project/Vishakhapatnam.png" alt="Our Project Real Images">
                        </div>
                    </div>
                </div>
            </div>

            <div class="row margin-2-rem-top md-margin-2-rem-top">
                <div class="col-12 col-lg-12 text-center wow animate__fadeIn" data-wow-delay="0.1s">
                    <a href="./projects" class="btn btn-link btn-extra-large text-extra-dark-gray text-extra-dark-gray-hover">Explore more
                    projects</a>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-12 col-lg-7 col-sm-8 text-center margin-3-rem-bottom md-margin-3-rem-bottom wow animate__fadeIn" style="visibility: visible; animation-name: fadeIn;">
                    ...
                    <h3 class="alt-font title-large-2 home_title text-theme font-weight-700 text-uppercase mb-0"> Our Clients
                    </h3>
                    <span class="d-inline-block alt-font text-extra-dark-gray text-large text-uppercase font-weight-500 letter-spacing-1px margin-20px-bottom margin-10px-top">was
                    accepted 10 years ago</span>
                </div>
            </div>
            <div class="row client-logo-style-06 justify-content-center">
                <div class="col-10 col-md-3 col-sm-6 border-right border-bottom border-color-black-transparent text-center xs-no-border-right wow animate__fadeIn">
                    <div class="client-box padding-4-rem-tb lg-padding-3-rem-tb xs-padding-4-rem-tb">
                        <img class="lazy-img" data-src="./includes/img/home/client/reliance.png" alt="DPR jewellery">
                    </div>
                </div>
                <div class="col-10 col-md-3 col-sm-6 border-right border-bottom border-color-black-transparent text-center sm-no-border-right wow animate__fadeIn" data-wow-delay="0.2s">
                    <div class="client-box padding-4-rem-tb lg-padding-3-rem-tb xs-padding-4-rem-tb">
                        <img class="lazy-img" data-src="./includes/img/home/client/FBB.png" alt="essar oil & gas">
                    </div>
                </div>
                <div class="col-10 col-md-3 col-sm-6 border-right border-bottom border-color-black-transparent text-center xs-no-border-right wow animate__fadeIn" data-wow-delay="0.3s">
                    <div class="client-box padding-4-rem-tb lg-padding-3-rem-tb xs-padding-4-rem-tb">
                        <img class="lazy-img" data-src="./includes/img/home/client/IndianOil.png" alt="FBB">
                    </div>
                </div>
                <div class="col-10 col-md-3 col-sm-6 border-bottom border-color-black-transparent text-center wow animate__fadeIn" data-wow-delay="0.4s">
                    <div class="client-box padding-4-rem-tb lg-padding-3-rem-tb xs-padding-4-rem-tb">
                        <img class="lazy-img" data-src="./includes/img/home/client/essar.png" alt="Indian Oil">
                    </div>
                </div>
                <div class="col-10 col-md-3 col-sm-6 border-right border-color-black-transparent text-center sm-border-bottom xs-no-border-right wow animate__fadeIn" data-wow-delay="0.8s">
                    <div class="client-box padding-4-rem-tb lg-padding-3-rem-tb xs-padding-4-rem-tb">
                        <img class="lazy-img" data-src="./includes/img/home/client/RCB.png" alt="RCB">
                    </div>
                </div>
                <div class="col-10 col-md-3 col-sm-6 border-right border-color-black-transparent text-center sm-no-border-right sm-border-bottom wow animate__fadeIn" data-wow-delay="0.7s">
                    <div class="client-box padding-4-rem-tb lg-padding-3-rem-tb xs-padding-4-rem-tb">
                        <img class="lazy-img" data-src="./includes/img/home/client/Sprint.png" alt="reliance">
                    </div>
                </div>
                <div class="col-10 col-md-3 col-sm-6 border-right border-color-black-transparent text-center xs-no-border-right xs-border-bottom wow animate__fadeIn" data-wow-delay="0.6s">
                    <div class="client-box padding-4-rem-tb lg-padding-3-rem-tb xs-padding-4-rem-tb">
                        <img class="lazy-img" data-src="./includes/img/home/client/SuhaniLaserWork.png" alt="Sprint">
                    </div>
                </div>
                <div class="col-10 col-md-3 col-sm-6 border-color-black-transparent text-center wow animate__fadeIn" data-wow-delay="0.5s">
                    <div class="client-box padding-4-rem-tb lg-padding-3-rem-tb xs-padding-4-rem-tb">
                        <img class="lazy-img" data-src="./includes/img/home/client/dpr.png" alt="Suhani Laser Work">
                    </div>
                </div>
            ...
            <div class="row margin-2-rem-top md-margin-2-rem-top">
                <div class="col-12 col-lg-12 text-center wow animate__fadeIn" data-wow-delay="0.1s">
                    <a href="./network" class="btn btn-link btn-extra-large text-extra-dark-gray text-extra-dark-gray-hover">Explore more
                    clients</a>
                </div>
            </div>
        </div>
    ...
    <section class="bg-theme1 padding-15px-tb">
        <div class="container-fluid">
            <div class="row justify-content-end">
                <div class="col-md-7 text-center">
                    <div class="d-flex justify-content-between">
                        <p class="mb-0 ps-sm-3 text-white"><b>© 2025 Gayatri Services</b></p>
                        <p class="mb-0 text-white"><span class="opacity-7-half font-weight-500">Design By</span> <span class="text-danger">♡</span> <a class="text-white" href="https://technobytesllp.in/" target="_blank">TBIS</a></p>
                    </div>
                </div>
