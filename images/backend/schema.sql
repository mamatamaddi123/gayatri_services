...
--
-- Table structure for table `doc_sequence_out`
--

CREATE TABLE `doc_sequence_out` (
  `branchId` int(11) NOT NULL,
  `seq_date` char(8) NOT NULL,
  `next_no` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `items` (
  ...
  `image_path` varchar(1260) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
--
-- Indexes for table `doc_sequence_out`
--
ALTER TABLE `doc_sequence_out`
  ADD PRIMARY KEY (`branchId`,`seq_date`);
